...
{
  /* sel idx 1（四分基础，无扫弦记谱）：v2.7.1 起带扫弦记谱的谱（如民谣扫弦）会让
...
section("T28 无障碍 · 开关语义 / 选中语义 / 分级播报 / 焦点陷阱（审计 P2-11）");
{
  ...
  eq((html.match(/role="switch"/g) || []).length, 11, "标记里 11 个 .toggle-pill 都声明了 role=switch（v1.4 +后台保活 +v2.0.0 曲式范围循环 +v2.4.2 六线底纹 +v2.4.3 练习循环 +v2.7.3 跳段行范围循环 +v2.32.0 面板锚点提示音 +v2.36.0 宽屏铺满）");
